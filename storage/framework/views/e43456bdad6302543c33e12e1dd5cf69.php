...
<body>
    <div class="container">
        ...
        <div style="text-align: center; margin-bottom: 20px; padding: 15px; background: #e8f4fd; border-radius: 10px; border: 2px solid #1262b4;">
            ...
            <a href="<?php echo e(route('tracking.show.es')); ?>" style="color: #1262b4; text-decoration: none; font-weight: 600; font-size: 16px;">📦 Rastrear sin iniciar sesión</a>
        </div>
        ...
        <div style="text-align: center; margin-top: 15px;">
            <a href="<?php echo e(route('password.request')); ?>" style="color: #666; text-decoration: none; font-size: 14px;">¿Olvidaste tu contraseña?</a>
        </div>
...
<?php /**PATH /Users/carloshurtado/Documents/ch-logistic-api/resources/views/auth/login.blade.php ENDPATH**/ ?>