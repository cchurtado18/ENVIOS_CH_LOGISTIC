    ...
    <div class="container">
        <div class="header">
            ...
            <div class="header-actions">
                <a href="<?php echo e(route('admin.inventory')); ?>" class="back-btn">← Volver a Inventario</a>
        ...
        <div class="card">
            ...
            <div class="client-select-box">
                <form method="GET" action="<?php echo e(route('admin.invoice.create')); ?>">
        ...
        <form method="POST" action="<?php echo e(route('admin.invoice.store')); ?>" id="invoiceForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="card">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="invoice_number" name="invoice_number" value="<?php echo e($nextInvoiceNumber); ?>" readonly style="background: #f0f0f0;">
                    </div>
                    <div class="form-group">
                        <label for="invoice_date">Fecha</label>
                        <input type="date" id="invoice_date" name="invoice_date" value="<?php echo e(date('Y-m-d')); ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="recipient_name" name="recipient_name" value="<?php echo e($shipments->first()?->user->name ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label for="recipient_location">Ubicación</label>
                        <input type="text" id="recipient_location" name="recipient_location" value="<?php echo e($shipments->first()?->user->department ?? ''); ?>">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label for="recipient_phone">Teléfono</label>
                        <input type="text" id="recipient_phone" name="recipient_phone" value="<?php echo e($shipments->first()?->user->phone ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label for="recipient_address">Dirección</label>
                        <input type="text" id="recipient_address" name="recipient_address" value="<?php echo e($shipments->first()?->user->address ?? ''); ?>">
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    <td class="checkbox-cell">
                                        <input type="checkbox" 
                                               ...
                                               onchange="toggleServiceInputs(this, '<?php echo e($shipment->id); ?>')">
                                    </td>
                                    ...
                                    <td>
                                        <input type="text" 
                                               name="services[<?php echo e($shipment->id); ?>][description]" 
                                               value="<?php echo e($shipment->description ?? ''); ?>" 
                                               class="description-input" 
                                               placeholder="Descripción del paquete" 
                                               disabled>
                                    </td>
                                    <td>
                                        <select name="services[<?php echo e($shipment->id); ?>][service_type]" 
                                                class="service-select" 
                                                disabled 
                                                required
                                                id="service_<?php echo e($shipment->id); ?>">
                                            <option value="">--Seleccione--</option>
                                            <option value="maritime">Marítimo</option>
                                            <option value="aerial">Aéreo</option>
                                        </select>
                                        <input type="hidden" name="services[<?php echo e($shipment->id); ?>][shipment_id]" value="<?php echo e($shipment->id); ?>">
                                    </td>
                                    <td>
                                        <input type="number" 
                                               step="0.01" 
                                               name="services[<?php echo e($shipment->id); ?>][price_per_pound]" 
                                               class="price-input" 
                                               placeholder="0.00" 
                                               disabled 
                                               required
                                               onchange="calculateValue(<?php echo e($shipment->id); ?>)"
                                               id="price_<?php echo e($shipment->id); ?>">
                                    </td>
                                    <td>
                                        <span id="value_<?php echo e($shipment->id); ?>" style="font-weight: 600; color: #1262b4;">$0.00</span>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
        ...
        <?php else: ?>
            <div class="card">
                <div style="text-align: center; padding: 40px;">
                    ...
                    <a href="<?php echo e(route('admin.inventory')); ?>" class="back-btn" style="margin-top: 20px;">← Volver a Inventario</a>
                </div>
            </div>
        <?php endif; ?>
    </div>
...
<?php /**PATH /Users/carloshurtado/Documents/ch-logistic-api/resources/views/admin/invoice/create.blade.php ENDPATH**/ ?>