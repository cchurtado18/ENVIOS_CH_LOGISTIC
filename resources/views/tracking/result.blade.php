...
<head>
    ...
    <title>Resultado de Tracking - CH Logistic</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align: center; margin-top: 30px; padding-top: 30px; border-top: 1px solid #e0e0e0;">
                <a href="{{ route('tracking.show.es') }}" class="btn-back">🔍 Rastrear Otro Paquete</a>
            </div>
            
            <div style="text-align: center; margin-top: 20px; padding-top: 20px; border-top: 1px solid #e0e0e0;">
                <p style="color: #666; margin-bottom: 15px; font-size: 14px;">¿Eres cliente?</p>
                <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                    <a href="{{ route('login') }}" style="display: inline-block; padding: 10px 20px; background: #f0f0f0; color: #333; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px;">🔐 Iniciar Sesión</a>
                    <a href="{{ route('register') }}" style="display: inline-block; padding: 10px 20px; background: #ff751f; color: white; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px;">✨ Registrarse</a>
                </div>
            </div>
        </div>
    </div>
